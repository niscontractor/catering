...
function PackageService($q, $http, $rootScope, $localStorage) {
    ...
    output.editPackage = function (packageObj) {
        var deferred = $q.defer();
        output.package;
        packageObj = JSON.parse(packageObj);
        var obj = {};
        ...
        obj.price = packageObj.price;
        obj.qty = packageObj.qty;
        console.log("package name : " + obj.name);
        console.log("package id : " + $rootScope.packageId);
        console.log("api : " + apiUrl + $rootScope.packageId);
        $http.put(apiUrl + $rootScope.packageId, obj)
                .success(function (data) {
                    output.package = data;
                    deferred.resolve(data);
                })

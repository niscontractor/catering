...
function dashboardCtrl($scope, $interval, $timeout, ReadJson) {
    var ctrl = this;
    ...
    ctrl.companyDetails = {delivery: true, typeOfCuisines: []};
...
angular
        .module('urbanApp')
        .controller('dashboardCtrl', ['$scope', '$interval', '$timeout', 'ReadJson', dashboardCtrl]);
